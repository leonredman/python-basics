...
# similar to a private method in a class
class RaceTime:
    ...
    def print_time(self):
        total_time = self._diff_time()  # internal method usage
    ...
    def _diff_time(self):   # internal method definition uses "_in front of name"
